    ...
    return (
        <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-4xl">
            <div className="relative bg-white p-6 rounded-2xl max-h-[95vh] overflow-y-auto custom-scrollbar w-full">
                ...
                {/* Top Tabs */}
                <div className="flex border-b mb-4 mt-8 text-sm font-medium gap-6">
                    {folderTabs.map((tab) => (
                        <button
                            key={tab}
                ...
                {activeTab === 'Select Files' ? (
                    <>
                        ...
                        <div className="flex items-center justify-between mb-4 gap-4">
                            <SearchFilter placeHolder='Search File' filters={filters} />
                        </div>
                    ...
                    <>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <SearchFilter placeHolder='Search Teacher' filters={filters} />
                            </div>
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    {isTeacherTab ? (
                                                        <>
                                                            <p className="text-xs text-[#ff3366]">{(person as Teacher).subject}</p>
                                                        ...
                                                        <>
                                                            ...
                                                            <p className="text-xs text-gray-500">
                                                                {(person as Student).level}
                                                            </p>
                                                            <p className="text-xs text-gray-500">
                                                                {(person as Student).group}
                                                            </p>
                                                        </>
                                                    )}
                                                </div>
