  ...
  return (
    <AuthLayout
      ...
      <form onSubmit={handlePasswordSet} className="space-y-6 flex flex-col">
        ...
        <button
          type="submit"
          className="self-center px-10 bg-[#3366FF] text-white font-semibold py-2.5 rounded-full hover:bg-opacity-90 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3366FF]">
          Set
        </button>
      </form>
    </AuthLayout>
