...
const RecordingCard: React.FC<{ recording: ClassRecording; onShared: () => void; onShare: () => void; onDelete: () => void; }> = ({ recording, onShared, onShare, onDelete }) => (
  <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-2  duration-200 flex items-center flex-wrap justify-between gap-4">
  ...
  return (
    ...
    <div className="bg-white rounded-2xl p-4 sm:p-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 items-center gap-2 sm:flex-nowrap justify-end lg:justify-start flex-shrink-0">
          <MonthTab />
