					...
					<div
						...
						<div className="bg-white px-2 py-1 rounded-2xl ">
							<div className="flex  items-start sm:items-center gap-4">
								...
								<div className="lg:pt-2 text-xs font-medium text-right sm:text-left space-y-0.5 text-black">
									<p>
										{' '}
										<span className="font-semibold">Gender:</span> Male
									</p>
									<p>
										<span className="font-semibold">DOB:</span> 15 Jun 2015
									</p>
									<p>
										<span className="font-semibold">Email:</span> example@gm.com
									</p>

									<p>
										<span className="font-semibold">City: </span> Mumbai
									</p>
									<p>
							...
							<div className="pt-4 ">
								<p className="text-md font-bold mb-3" style={{ color: PALETTE.TEXT_DARK }}>
									Key Focus Area
								</p>
