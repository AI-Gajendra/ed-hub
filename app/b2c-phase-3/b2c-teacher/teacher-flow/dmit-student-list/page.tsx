...
const StudentCard: React.FC<{ student: Student }> = ({ student }) => {
    return (
        <Link href={"/b2c-phase-3/b2c-teacher/teacher-flow/dmit-student-paper"} className="bg-[#F9FAFB] border border-[#B0B0B0] rounded-2xl p-2 flex flex-col gap-1.5 sm:flex-row sm:items-center sm:space-x-4 ">
            {/* Avatar */}
            <Image
                width={100}
                height={100}
