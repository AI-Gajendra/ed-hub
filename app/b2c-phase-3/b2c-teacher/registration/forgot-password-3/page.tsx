				...
				<div className="relative flex flex-col md:flex-row-reverse gap-2 sm:gap-6 w-full max-w-6xl p-3 md:p-6 bg-white rounded-2xl overflow-hidden">
					...
					<div className="w-full md:w-[45%] py-2 md:py-8 md:mt-12 px-2 md:px-6 flex flex-col">
						<div className="w-full ">
							<h2 className="font-Poppins text-2xl font-bold">Set Password</h2>
							...
							<div className="mt-6 space-y-4 sm:space-y-5 flex flex-col">
								<div>
									<Label className="font-medium text-[16px]" htmlFor="password">New Password</Label>
									<Input
										id="password"
										type="password"
								...
								<div className="mt-6 space-y-4 sm:space-y-5 flex flex-col">
									<div>
										<Label className="font-medium text-[16px]" htmlFor="confirmPassword">Confirm Password</Label>
										<Input
											id="confirmPassword"
											type="password"
									...
									<Button className="self-center rounded-full w-36 h-12 font-light text-base text-white" onClick={() => { Router.push("/b2c-phase-3/b2c-teacher/registration/login") }}>
										Confirm
									</Button>
								</div>
