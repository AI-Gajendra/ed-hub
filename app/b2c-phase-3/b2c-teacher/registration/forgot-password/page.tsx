		  ...
		  <div className="w-full md:w-[45%] py-2 md:py-8 md:mt-12 px-2 md:px-6 flex flex-col">
			<div className="w-full ">
			  ...
			  <div className="mt-6 space-y-4 sm:space-y-5 flex flex-col">
				...
				<Button className="self-center rounded-full w-36 h-12 font-light text-base text-white" onClick={()=>{Router.push("/b2c-phase-3/b2c-teacher/registration/forgot-password-3")}}>
				  Proceed
				</Button>
			  </div>
