...
import StudentNavbar from "@/components/b2c-phase-3/b2c-teacher/student-navbar";
...
export default function Landing() {
  ...
  return (
    <div>
      ...
      {/* Page 3 - About Us */}
      <div className="relative  font-main w-full px-4 md:px-24 min-h-[calc(100vh-7.5rem)] flex flex-col overflow-hidden">
        {/* Background Layer */}
        <div
          className="absolute inset-0 bg-center bg-repeat z-0"
          style={{
      ...
      >
        <div className="relative z-10 pt-12 px-4 flex flex-col gap-6 items-center w-full h-full">
          ...
          {/* Image takes remaining space */}
          <motion.div
            className="flex-grow w-full py-10 flex justify-center items-center overflow-hidden"
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
