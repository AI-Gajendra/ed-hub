...
import SelectionCard from "./popupComponent/select-type";
...
export default function AllTeacherB2CPopups() {
  ...
  const modalButtons = [
    {
      ...
      action: () => setOpenModal("AskMeAnything"),
    },
    {
      id: "reportButtons",
      label: "Buttons",
      action: () => setOpenModal("reportButtons"),
    },
    {
      id: "videoPlayer",
      label: "Video Player Popup",
      action: () => setOpenModal("videoPlayer"),
    },
    {
      id: "select",
      label: "select Popup",
      action: () => setOpenModal("select"),
    },
  ];
  ...
  return (
    <div className="bg-gray-200 min-h-screen p-10 font-sans">
      ...
      />
      <ReportButtonsPopup
        isOpen={openModal === "reportButtons"}
        onClose={() => setOpenModal(null)}
      />
      <VideoPlayerPopup
