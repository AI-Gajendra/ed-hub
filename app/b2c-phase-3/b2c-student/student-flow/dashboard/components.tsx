            ...
            <div className="bg-white rounded-2xl p-4 md:p-6"> {/* Base padding for mobile, md:p-6 for desktop */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-x-4 mt-6 md:mt-8">
                    <div
                        ...
                        onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/assessment-result")} className="bg-[#F3F4F6] cursor-pointer p-3 md:p-4 rounded-xl text-center">
                    ...
                    <div
                        onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/report")}
        ...
        <div className="bg-white rounded-2xl p-4 md:p-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 flex-wrap">
                ...
                <OutlineButton label="Yearly Plan Overview"
                    onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/yearly-plan")} />
            </div>
...
const TeacherItem: React.FC<Teacher> = ({ avatarSrc, name, subject }) => (
    <Link href="/b2c-phase-3/b2c-student/student-flow/chat-page" className="flex items-center justify-between p-1.5 md:p-2 bg-gray-100 rounded-full ">
