        ...
        return (
          <div className="space-y-3">
            {assessmentDataPage.map((assessment) => (
              <AssessmentItem key={assessment.id} assessment={assessment} onClick={() => Router.push("/b2c-phase-3/b2c-student/student-flow/startup-math")} />
            ))}
          </div>
        );
      case "Mock Papers":
        return (
          <div className="space-y-3">
            {mockPapersDataPage.map((item) => (
              <MockPaperItem key={item.id} item={item} onClick={() => Router.push("/b2c-phase-3/b2c-student/student-flow/mock-papers-3")} />
            ))}
          </div>
        );
      case "Work Sheet":
        return (
          <div className="space-y-3">
            {workSheetDataPage.map((item) => (
              <WorkSheetItem key={item.id} item={item} onClick={() => Router.push("/b2c-phase-3/b2c-student/student-flow/my-class-worksheet-3")} />
            ))}
          </div>
        );
      default:
