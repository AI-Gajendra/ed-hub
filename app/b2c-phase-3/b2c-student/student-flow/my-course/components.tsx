...
export const CourseCard: React.FC<CourseCardProps> = ({ course }) => {
    ...
    if (course.isKnowledgeBox) {
        return (
            <div onClick={() => Router.push("/b2c-phase-3/b2c-student/student-flow/my-class")} className="bg-[#F9FAFB] border-[#E5E7EB] border rounded-2xl p-3 flex flex-col h-full hover:shadow-xl cursor-pointer transition-shadow duration-200">
    ...
    return (
        <div onClick={() => {
            if (!isCompleted) Router.push("/b2c-phase-3/b2c-student/student-flow/single-course-detail")
