  ...
  return (
    <div className="bg-[#eeeeee]">
      ...
      <div className="mx-auto bg-[#eeeeee] p-3 sm:p-4 md:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-4 sm:gap-8 px-1 py-4 sm:p-4">
          {/* Left column */}
          ...
          <div className="font-medium">
            <div className="bg-white  md:p-8 h-fp-3 it sm:p-6 rounded-2xl overflow-auto">
            ...
            <div className="bg-white p-3 sm:p-6  md:p-8 mt-6 rounded-2xl space-y-6">
              {/* Title */}
