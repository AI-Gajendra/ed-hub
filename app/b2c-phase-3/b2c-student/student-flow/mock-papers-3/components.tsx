  ...
  return(
    <form onSubmit={onSubmit} className="w-full">
        ...
        <div className="mt-8 flex justify-center sm:mt-10">
            <ActionButton 
onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/mock-paper-result")}  type="submit" fullWidthOnMobile={false}> {/* fullWidthOnMobile=false to match original centered button */}
                Submit
            </ActionButton>
        </div>
    </form>
