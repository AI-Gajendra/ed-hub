...
export const QuizResultItem: React.FC<QuizResultItemPropsComponent> = ({ item, activeTab }) => {
    ...
    const handleClick = () => {
        if (activeTab === "Result") Router.push("/b2c-phase-3/b2c-student/student-flow/quiz-result")
        else if (activeTab === "Quiz" && !item.isLocked) Router.push("/b2c-phase-3/b2c-student/student-flow/quiz-page")
    }
    return (
