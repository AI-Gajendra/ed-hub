            ...
            <div className="bg-[#F9FAFB] space-y-4 rounded-2xl p-4 lg:p-7">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {startingCourses.map((course) => (
                  <Card
                    key={course.id}
                    onClick={() => Router.push("/b2c-phase-3/b2c-student/student-flow/courses/detail")}
                ...
                <div className="w-full">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8 mx-auto lg:mx-0">
                      ...
                      <button
                        onClick={() => Router.push("/b2c-phase-3/b2c-student/student-flow/courses")}
        ...
        <TabsList className="flex flex-nowrap overflow-x-auto custom-scrollbar-thin justify-between gap-2 bg-transparent h-auto">
          {categories.map((category) => {
            ...
            return (
              ...
              //   key={category}
              //   value={category}
              //   onClick={() => Router.push("/b2c-phase-3/b2c-student/student-flow/courses/categorical")}
              ...
              <Button
                ...
                className={`${isActive ? "bg-[#FF3366] text-white" : "bg-transparent text-[#6B7280]"}  hover:bg-black/10 cursor-pointer rounded-full px-4 py-2 text-sm xl:text-base font-medium break-words max-w-full`}
              >
                {category}
              </Button>
            );
