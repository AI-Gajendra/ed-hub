...
import VideoPlayerPopup from "@/app/b2c-phase-3/b2c-student/pop-ups/popupComponent/VideoPlayerPopup";
        ...
        <div className="relative py-14 rounded-2xl">
          <div className="relative flex gap-4 items-center flex-col md:flex-row justify-center w-full z-9">
            ...
            <button
              ...
              onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/demo/booking-form")} className='bg-white cursor-pointer rounded-full px-8 py-2 text-m font-medium'>Click Here</button>
          </div>
          <div
                ...
                >
                  ...
                  <div className="p-3 pt-0 space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <Link href={"/b2c-phase-3/b2c-student/student-flow/know-more"} className="font-main text-sm text-[#FF3366] relative z-10 w-fit border-b border-b-[#FF3366] cursor-pointer">
                        Know More
                      </Link>
                    </div>
