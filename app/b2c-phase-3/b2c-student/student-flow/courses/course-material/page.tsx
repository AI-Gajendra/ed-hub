      ...
      <section className="bg-[#EEEEEE] p-4 md:p-6 lg:p-10">
        <div className="w-full max-w-7xl min-h-screen mx-auto space-y-6 p-4 bg-white rounded-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/material-knowledge-box")}  className="bg-[#F9FAFB] rounded-3xl cursor-pointer border border-[#E5E7EB] overflow-hidden p-2">
            ...
            {new Array(2).fill(0).map((_, index) => (
              <div
              onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/material-page-course")} 
                key={index}
