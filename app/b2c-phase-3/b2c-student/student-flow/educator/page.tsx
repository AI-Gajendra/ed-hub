...
import StudentWrapper from "@/components/b2c-phase-3/student-wrapper"; // Assuming this path is correct
...
const EducatorCard = ({ educator }: { educator: Educator }) => {
  ...
  return (
    <Link href={"/b2c-phase-3/b2c-student/student-flow/teacher-profile"}>
