        ...
        <section className="px-2 md:px-8 lg:px-12 xl:px-16 py-8">
          <div className="rounded-3xl max-w-7xl mx-auto bg-white space-y-4 p-4">
            ...
            <div className="md:grid md:grid-cols-[1fr_1fr] gap-16">
              ...
              onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/demo/booking-form")} className="bg-[#F9FAFB] border border-[#E5E7EB] px-8 py-4 rounded-full text-black hover:bg-[#F9FAFB] cursor-pointer">
                  Edit
                </Button>
              </div>
            ...
            <div className="flex items-center justify-center">
              <Button
                ...
                onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/demo/confirmation")}
              >
                Book
              </Button>
            </div>
