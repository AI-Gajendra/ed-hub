              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-center">
                  <Button
                    ...
                    onClick={() => router.push("/b2c-phase-3/b2c-student/student-flow/demo/course-fee-payment")} className="bg-[#3366ff] text-white px-8 py-4 hover:bg-[#0c45f0] hover:text-white rounded-full">
                    Submit Feedback
                  </Button>
                </div>
              </div>
