...
import StudentB2CWrapper from '@/components/b2c-phase-3/b2c-student/common-components/StudentB2CWrapper';
            ...
            <StudentB2CWrapper>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[4fr_3fr_3fr] my-4 gap-4">
                    <div className="bg-white rounded-2xl p-6 sm:col-span-2 lg:col-span-1">
                        ...
                        {/* Badges */}
                        <div className="flex gap-2 mt-6 w-full justify-start flex-wrap">
