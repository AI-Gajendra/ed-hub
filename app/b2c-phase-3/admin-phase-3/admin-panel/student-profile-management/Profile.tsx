...
export default function StudentProfile() {
  ...
  return (
    <div className="bg-white rounded-3xl p-4 space-y-4">
      ...
      <h2 className="text-xl font-semibold text-gray-800 border-b-1 border-gray-200 pb-4">Student&apos;s Profile</h2>
      ...
      {/* Save Button */}
      <h2 className="text-xl font-semibold text-gray-800 pb-4">Teacher&apos;s Profile</h2>

      {/* Form */}
      <form className="grid grid-cols-1 md:grid-cols-2 pb-6 border-b-1 border-gray-200 gap-4 md:gap-x-[4rem] gap-y-7">
        {/* First Name */}
        <div className="space-y-1">
          <label className="text-sm font-medium">Father&apos;s First Name</label>
          <input
            type="text"
            defaultValue="Parth"
            className="w-full rounded-[12px] mt-2 border border-gray-200 px-4 py-2 text-sm bg-[#f9fafb]"
        ...
        {/* Last Name */}
        <div className="space-y-1">
          <label className="text-sm font-medium">Father&apos;s Last Name</label>
          <input
            type="text"
            placeholder="Last Name"
            className="w-full rounded-[12px] mt-2 border border-gray-200 px-4 py-2 text-sm bg-[#f9fafb]"
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium">Mother&apos;s First Name</label>
          <input
            type="text"
            defaultValue="Parth"
            className="w-full rounded-[12px] mt-2 border border-gray-200 px-4 py-2 text-sm bg-[#f9fafb]"
        ...
        {/* Last Name */}
        <div className="space-y-1">
          <label className="text-sm font-medium">Mother&apos;s Last Name</label>
          <input
            type="text"
            placeholder="Last Name"
            className="w-full rounded-[12px] mt-2 border border-gray-200 px-4 py-2 text-sm bg-[#f9fafb]"
