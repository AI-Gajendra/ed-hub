      ...
      <form className="space-y-4 flex flex-col">
        ...
        <div>
          ...
          <div className="flex justify-end items-center my-2">
            <Link href="/teacher-b2b/registration/forgot-password" className="text-xs font-medium text-[#6B7280] hover:underline">
              Forgot Password?
            </Link>
          </div>
        </div>
        ...
        <div className="self-center text-center text-[9px] w-fit text-[#6B7280] border-b-2 border-black px-1">
          <Link href="/teacher-b2b/registration/choose-profile" className=" text-[#6B7280]">
