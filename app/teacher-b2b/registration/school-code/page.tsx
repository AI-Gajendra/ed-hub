		...
		<AuthLayout
			...
			<div className="space-y-2">
				...
				<input
					...
					className="w-full py-3 px-4 border border-[#D5D5D5] bg-[#F9FAFB] placeholder:text-[#777777] text-sm focus:outline-none focus:ring-2 transition"
					style={{
				...
				<button
					onClick={() => Router.push('/teacher-b2b/registration/register')}
