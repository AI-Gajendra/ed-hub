...
import DeleteVideoModal from "@/app/b2c-teacher/ct-pop-ups/popupComponent/DeleteVideo";
import ShareWithManage3VideoPopup from "@/app/b2c-teacher/ct-pop-ups/popupComponent/ShareWithManage3";
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex-grow flex flex-col">
        ...
        <div className=" flex justify-start gap-2 items-center text-xs text-gray-500">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button onClick={() => setSharePopup(true)} className="px-2 py-2 text-xs rounded-full bg-blue-100 text-blue-700 flex items-center gap-1">Shared
            </button>
      ...
      <DeleteVideoModal isOpen={deletePopup} onClose={() => setDeletePopup(false)} />
      <ShareWithManage3VideoPopup isOpen={sharePopup} onClose={() => setSharePopup(false)} />
    </div>
  );
};
  ...
  return (
    <div className=" bg-white rounded-2xl h-fit flex-grow container mx-auto p-4 sm:p-6 space-y-6 relative">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 items-start justify-start sm:items-center gap-2 sm:gap-3  sm:self-center">
          <MonthTab />
