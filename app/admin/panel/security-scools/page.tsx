		...
		<div className="flex flex-wrap md:flex-nowrap gap-4 items-center">
			...
			<div className="flex gap-4 w-full">
				{buttons.map((btn, indx) => (
					<Button key={indx} className="flex-1 rounded-xl bg-[#F9FAFB] hover:bg-[#F9FAFB]/90 text-black border border-[#E5E7EB]">
						{btn}
					</Button>
				))}
			</div>
			...
			<Card className="shadow-none bg-[#F9FAFB] flex flex-col sm:flex-row gap-3 sm:gap-4 p-3 sm:p-4">
				...
				<div className="flex flex-col justify-between gap-2 sm:gap-2 flex-1">
					...
					<div className="flex justify-end gap-4 items-center">
						<Button size={'icon'} className="rounded-full bg-[#F2F3F3] hover:bg-[#F2F3F3]/90">
							<svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<g clipPath="url(#clip0_6593_108700)">
									<path
