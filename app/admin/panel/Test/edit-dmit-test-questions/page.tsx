            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between gap-4 w-full my-4">
                  <span>Options</span>
                  <Input
                    className="w-18 rounded-full ml-auto placeholder:text-center"
                    placeholder="4"
                    type="number"
                  />
                </div>
              ...
              <div className="flex flex-col gap-4 w-fit">
                <Button className="text-white bg-[#FFCC00] rounded-full py-6 text-sm"  onClick={() => setOpenModal("uploadFileImage")}>
                  Upload Image / File
                </Button>
