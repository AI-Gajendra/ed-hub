      ...
      <div className="p-4">
        <MaxWidthWrapper className="bg-white p-4 sm:p-8 rounded-2xl">
          ...
          {questions.map((question, indx) => (
            <div
              key={indx}
              className="rounded-2xl bg-[#F9FAFB] p-4 mt-6 max-w-2xl"
            >
              ...
              <div className="mt-4">
                ...
                {question.options.map((option, indx) => (
                  <div
                    key={indx}
                    className={cn(
                      "rounded-full font-medium my-2 bg-white text-[#6B7280] p-4",
              ...
              <Button className="py-6 bg-[#B0B0B01A] hover:bg-[#B0B0B02A] text-black mt-4 rounded-full px-5">
                Edit
              </Button>
            </div>
          ))}
