...
export default function SchoolManagementReportPage() {
  ...
  const tabs = [
    ...
    {
      label: "Teachers",
      link: "/admin/panel/school-management-teacher-student",
    },
    ...
    <div>
      ...
      <MaxWidthWrapper className="bg-white rounded-2xl py-4 my-4 overflow-hidden">
        <div className="flex items-center justify-start gap-8 mb-4 font-medium">
          {tabs.map((tab, indx) => (
            <Link key={indx} href={tab.link}>
              <div
                className={cn(
                  "text-[#6B7280]",
                  selectedTab === tab.label &&
                    "text-[#3366FF] underline underline-offset-8 decoration-2"
                )}
          ...
          <div className="flex flex-wrap lg:flex-nowrap gap-4 sm:gap-6">
            ...
            <div className="w-full lg:w-[30%]">
              ...
              <p>
                ...
                Vivamus sit amet sem ac nibh bibendum condimentum vel in sem.
                Curabitur tincidunt pretiutm faucibus. Vestibulum eget
        ...
        <div className="grid sm:grid-cols-2 lg:flex gap-8">
            ...
            <div className="space-y-2">
              {[
                ...
                >
                  <Progress
                    value={100}
                    innerClass="bg-[#3366FF] rounded-full"
                    className="bg-white h-7 rounded-full"
                  />

                  <div className="absolute top-1/2 -translate-y-1/2 text-white left-2 text-sm">
                    {batch.name}
                  </div>
                  <div className="absolute top-1/2 -translate-y-1/2 text-white right-2 text-[10px]">
                    {batch.score}
                  </div>
                </div>
              ))}
          ...
          <div className="pt-8 overflow-hidden sm:col-span-2 lg:max-w-xs w-full flex flex-col justify-between items-center gap-20 border border-[#F2F2F2] max-h-80 shadow-xs rounded-2xl">
            ...
            <div className="relative">
              <div className="relative">
                <div
                  className="flex justify-center items-center w-full scale-150"
              ...
              <div className="text-4xl font-semibold absolute top-2/5 -translate-y-1/2 left-1/2 -translate-x-1/2">
                50
              </div>
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="flex flex-col sm:flex-row gap-8 items-center mt-8">
              ...
              <ul className="px-4 sm:px-0 list-disc sm:text-nowrap text-xs lg:text-[0.60rem] xl:text-xs">
                ...
                <li>
                  Proin interdum justo et nunc dapibus, a pulvinar urna
                  venenatis.
                </li>
                <li>
                  Fusce id risus vitae enim consequat pulvinar non non dui.
                </li>
                <li>
                  Ut eu massa tempor, ultricies sapien quis, gravida lectus.
                </li>
                <li>
                  Aliquam id lectus vulputate, laoreet nisl sit amet, pharetra
                  elit.
                </li>
                <li>
                  Proin interdum justo et nunc dapibus, a pulvinar urna
