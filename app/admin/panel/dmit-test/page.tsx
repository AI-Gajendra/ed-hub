    ...
    <MaxWidthWrapper className="px-4">
      <div className="bg-white rounded-2xl p-6 mt-6 mb-20 flex flex-col gap-8 md:flex-row justify-between items-start">
        <div className="w-full sm:w-auto">
          ...
          />
          <h1 className="text-[#3366FF] font-semibold text-2xl underline underline-offset-8">
            DMIT
          </h1>
          ...
          <div className="flex flex-col items-end justify-center gap-4">
            ...
            <div className="flex justify-between sm:justify-center flex-wrap gap-4">
              ...
              <Button
  className="rounded-full bg-[#3366FF1A] shadow-none hover:bg-[#3366FF1A]/90 text-[#3366FF]"
  onClick={() => setOpenModal("existDmitTest")}
>
  View Existing Test
</Button>
              <Button className="rounded-full w-32 px-6 shadow-none">
                Save
              </Button>
            </div>
          </div>
