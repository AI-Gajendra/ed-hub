    ...
    <>
      <div className="bg-[#EEEEEE] min-h-screen">
        ...
        <div className="px-4 space-y-4 my-10">
          <div
            className=" px-4 mx-auto rounded-2xl p-4 "
            style={{
          ...
          >
            <div className="bg-white rounded-2xl p-2">
              <div className="flex flex-col font-main sm:flex-row justify-between items-start gap-6 sm:gap-8">
                <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-start">
                  ...
                  <div className="space-y-2 font-main text-center sm:text-left">
                    <h1 className="font-semibold text-lg sm:text-xl tracking-wide">
                      Teacher Name
                    </h1>
                    <div className="flex flex-wrap gap-1 justify-center sm:justify-start">
                      <div className="bg-[#FF3366] rounded-l-full text-xs font-light px-3 py-1.5 text-white">
                        Class Assigned
                      </div>
                      <div className="bg-[#FF3366] rounded-r-full text-xs font-light px-3 py-1.5 text-white">
                        Class Assigned
                      </div>
                    </div>
                  </div>
                ...
                <div className="text-sm space-y-1 mt-4 sm:mt-0">
                  ...
                  <p className="font-medium">
                    State: <span className="font-light">Maharashtra</span>
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="flex gap-4 items-center justify-start text-sm mt-4">
                  <p className="bg-[#F3F4F6] p-2 rounded-full border border-[#B0B0B0]">
                    +91 0000000000
                  </p>
                  <p className="bg-[#F3F4F6] p-2 rounded-full border border-[#B0B0B0]">
                    example@gm.com
