...
import SchoolManagementReportPage from "@/components/admin/branch";
...
function TeacherRectangle() {
  return (
    <Link href={"/admin/panel/school-MGMT/teacher-performance"}>
...
function StudentRectangle() {
  return (
    <Link href={"/admin/panel/school-MGMT/student-progress-report"}>
