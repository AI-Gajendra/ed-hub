...
function SearchFilterBar() {
  return (
    <div className="flex flex-wrap md:flex-nowrap gap-4 items-center">
      ...
      <Link
        href="/admin/panel/school-MGMT/manage-all-approval"
        className="text-xs  px-2 font-medium py-3 bg-[#FF3366] font-main text-white rounded-full inline-block whitespace-nowrap"
      >
        Manage Approval
      </Link>
      <DropdownMenu>
...
const SchoolCard = () => {
  return (
    <Link href={"/admin/panel/school-MGMT/school-management-report"}>
      <Card className="shadow-none bg-[#F9FAFB] flex flex-col sm:flex-row gap-3 sm:gap-4 p-3 sm:p-4">
        ...
        <div className="flex flex-col justify-between gap-2 sm:gap-2 flex-1">
          <div>
            ...
            <p className="text-[#6B7280] text-xs sm:text-xs font-light truncate">
              Address
            </p>
            <p className="text-[#6B7280] text-xs sm:text-xs font-light truncate">
              Detail 1
