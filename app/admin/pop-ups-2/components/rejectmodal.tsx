...
const RejectChoiceModal: React.FC<PopupProp> = ({ isOpen, onClose }) => {
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-md">
      <div className="relative bg-white p-6 rounded-2xl w-full">
        ...
        <div className="mt-6 flex justify-end gap-4">
          ...
          <button
            className="rounded-full px-6 py-2 bg-[#ff3366]/10 text-[#ff3366] text-sm font-medium hover:bg-blue-700"
          >
            Confirm
          </button>
        </div>
...
export default RejectChoiceModal;
