...
export const UploadFileImage: React.FC<PopupProp> = ({ isOpen, onClose }) => {
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-md">
      <div className="rounded-3xl px-4 pt-6 pb-4 ">
        ...
        <div className="flex flex-col gap-1 pb-4 mt-6">
          <label className="font-medium text-md mb-2" htmlFor="url">
            Enter URL
          </label>
          <input
            id="url"
            type="text"
            className="rounded-full px-4 py-2 bg-gray-50 border"
            placeholder="Text"
          />
        </div>
        <div className="text-center mt-4 mb-2">Or</div>
        ...
        <div className=" flex justify-end items-center gap-3 mt-4">
          <button className="text-[#6b7280] border border-[#e7e5eb] px-5 py-3 rounded-full">
            Cancel
          </button>
          <Link href={"/admin/panel/edit-dmit-test-questions"}>
            <button className="bg-[#3366ff] px-6 py-3 text-white rounded-full">
              Add
            </button>{" "}
          </Link>
        </div>
...
export const UploadContentImage: React.FC<PopupProp> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-md">
      <div className="rounded-3xl px-4 pt-6 pb-4 ">
        ...
        <div className=" flex justify-end items-center gap-3 mt-4">
          <button
            className="text-[#6b7280] border border-[#e7e5eb] px-5 py-3 rounded-full"
            onClick={onClose}
          >
            Cancel
          </button>
          <button
            className="bg-[#3366ff] px-6 py-3 text-white rounded-full"
...
export const AddItem: React.FC<PopupProp> = ({ isOpen, onClose }) => {
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-md">
      <div className="rounded-3xl px-4 pt-6 pb-4 ">
        ...
        <div className="flex flex-col gap-1 pb-4 mt-6">
          <label className="font-medium text-md mb-2" htmlFor="itemName">
            Item Name
          </label>
          <input
            id="itemName"
        ...
        <div className="flex flex-col gap-1 pb-4 my-2">
          <label className="font-medium text-md mb-2" htmlFor="description">
            Description
          </label>
          <input
            id="description"
        ...
        <div className="flex flex-col gap-1 pb-4 mt-4">
          <label className="font-medium text-md mb-2" htmlFor="stocks">
            Stocks
          </label>
          <input
            id="stocks"
        ...
        <div className="w-full flex items-center justify-center">
          <button
            onClick={onClose}
            className="cursor-pointer text-center px-6 py-2.5 rounded-full text-white bg-[#3366ff]"
          >
            Add Item
          </button>
        </div>
...
export default function AllPopupsPage() {
  ...
  const modalButtons = [
    ...
    { id: "rejectchoice", label: "reject  choice model" },
