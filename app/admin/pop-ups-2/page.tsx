        ...
        <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-md">
            <div className="rounded-3xl px-4 pt-6 pb-4 ">
                ...
                <div className=" flex justify-end items-center gap-3 mt-4">
                    <button className="text-[#6b7280] border border-[#e7e5eb] px-5 py-3 rounded-full">Cancel</button>
                      <Link href={"/admin/panel/edit-dmit-test-questions"}><button className="bg-[#3366ff] px-6 py-3 text-white rounded-full">Add</button>  </Link >
                </div>
            </div>
        </BaseModal>
    );
