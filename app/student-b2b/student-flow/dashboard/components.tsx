...
import ReportButtonsPopup from '@/app/b2c-student/pop-ups/popupComponent/ReportButtons';
import WarningPopup from '@/app/b2c-student/ct-student-b2c-popups/components-popups/WarningPopup';
import CancelLectureModal from '@/app/b2c-student/ct-student-b2c-popups/components-popups/CancelLecture';
        ...
        <>
            <div className="bg-white rounded-2xl p-4 md:p-6"> {/* Base padding for mobile, md:p-6 for desktop */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-x-4 mt-6 md:mt-8">
                    ...
                    <div
                        onClick={() => router.push("/student-b2b/student-flow/report")}
...
export const LearningActivitiesSection: React.FC<LearningActivitiesSectionProps> = ({ activities, currentFilter, onFilterChange, currentDate, onDatePrev, onDateNext }) => {
    ...
    return (
        <div className="bg-white rounded-2xl p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 sm:flex whitespace-nowrap justify-between items-start sm:items-center mb-6 gap-4 flex-wrap">
                <MonthTab />
                ...
                <OutlineButton label="Yearly Plan Overview"
                    onClick={() => router.push("/student-b2b/student-flow/yearly-plan")} />
            </div>
...
const TeacherItem: React.FC<Teacher> = ({ avatarSrc, name, subject }) => (
    <Link href="/student-b2b/student-flow/chat-page" className="flex items-center justify-between p-1.5 md:p-2 bg-gray-100 rounded-full ">
