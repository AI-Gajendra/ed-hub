...
const completedCoursesData: Course[] = [
    ...
    { id: 8, status: 'completed', imageSrc: '/course-image-personality.jpg', category: 'PERSONALITY DEVELOPMENT', name: 'Course Name Golf', domain: 'Self Dev.', levelGrade: 'Grade 4', pendingClasses: '2 out of 16', progress: 100 },
];
// --- End Sample Data ---
