...
export const QuizResultItem: React.FC<QuizResultItemPropsComponent> = ({ item, activeTab }) => {
    ...
    const handleClick = () => {
        if (activeTab === "Result") Router.push("/student-b2b/student-flow/quiz-result")
        else if (activeTab === "Quiz" && !item.isLocked) Router.push("/student-b2b/student-flow/quiz-page")
    }
    return (
