            ...
            >
                ...
                <div className="relative w-full max-w-screen-xl bg-white rounded-3xl p-6 md:p-12 lg:p-16">
                    ...
                    <div className="mt-8 max-w-lg mx-auto flex flex-col items-center gap-6">
                        ...
                        <button className="w-full max-w-xs bg-[#3366FF] text-white font-bold py-3 px-6 rounded-full text-lg hover:bg-blue-700 transition-all duration-200 -lg hover:-xl">
                            Continue
                        </button>
                    </div>
                </div>
            ...
            <div className="min-h-screen w-screen bg-white flex items-center justify-center p-4 sm:p-6">
                ...
                <div className="w-full max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-6 flex justify-center">
                        <button
                            className="bg-[#3366FF] text-white font-semibold text-lg px-12 py-2.5 rounded-full hover:bg-blue-700 transition-colors duration-200 -lg hover:-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                        >
                            Start
                        </button>
                    </div>
