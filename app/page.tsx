	...
	return (
		<LandingWrapper>
			...
			<div className="relative w-full px-4 md:px-24 min-h-[calc(100vh-7.5rem)] flex flex-col overflow-hidden">
				...
				{/* Foreground Content */}
				<div className="relative z-10 p-6 md:p-12 px-0 sm:px-4 md:px-8 flex flex-col gap-6 items-center w-full h-full">
					<motion.h1
			...
			<div
				className="w-full flex flex-col md:flex-row gap-6 md:gap-3 px-0 sm:px-6 md:px-[9%] items-center justify-between bg-cover bg-center bg-no-repeat"
				style={{
					backgroundImage: "url('/Background3.png')",
				}}>
				<div className="relative z-10 py-6 sm:py-12 px-4 flex flex-col gap-6 items-center w-full h-full">
			...
			<div
				className="sm:px-6 py-10 bg-cover bg-center bg-no-repeat"
				style={{
					backgroundImage: "url('/Background4.png')",
				}}>
				<div className="relative z-10 px-4 flex flex-col gap-6 items-center w-full h-full">
					<h1 className="text-2xl md:text-4xl text-center font-semibold text-black">Benefits of Online Education</h1>
			...
			<div className="relative min-h-screen w-screen flex justify-around bg-gradient-to-r from-[#fcdecf] to-[#fdc1d7] pt-16">
				<div className="w-full sm:max-w-5/7 p-4 pb-20">
					{cardData.map((card, index) => (
						<div key={card.id} className="relative w-full rounded-3xl overflow-hidden shadow-lg mb-8 transition-all duration-300">
							{/* Background Image */}
							<div className="absolute inset-0 w-full h-full">
								<Image src={card.image} alt={`Card background ${index + 1}`} fill className="object-fit" priority />
							</div>

							{/* Content */}
							<div className="relative z-10 p-8 md:p-12 h-40 sm:h-64"></div>
						</div>
					))}
				</div>
				{/* 7 footer */}
								...
								<div className="p-5 flex flex-col items-center">
									...
									<div className="flex items-center justify-between w-full mb-4 mt-4 border-t">
										<div className="flex items-center">
											...
											<span className="text-sm text-[#F9326F]">{post.author}</span>
										</div>
