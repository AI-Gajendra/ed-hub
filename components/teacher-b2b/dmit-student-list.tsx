...
const StudentCard: React.FC<{ student: Student }> = ({ student }) => {
	return (
		<Link href={"/teacher-b2b/teacher-flow/dmit-student-paper"} className="bg-[#F9FAFB] border border-[#B0B0B0] rounded-2xl p-2 justify-between flex flex-col gap-1.5 sm:flex-row sm:items-center sm:space-x-4 ">
