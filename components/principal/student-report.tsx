...
import { MdOutlinePsychology, MdOutlineSuperscript, MdOutlineTheaterComedy } from "react-icons/md";
...
const PrincipalStudentReport: React.FC = () => {
...
export default PrincipalStudentReport;
