...
export default function Testimonials() {
	...
	const duplicatedSlides = [...testimonials.slice(-cardsToShow), ...testimonials, ...testimonials.slice(0, cardsToShow)]
			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
					<div>
						...
						<p className="text-xl tracking-wider font-medium text-gray-700">Don&apos;t just take our word for it.</p>
					</div>
					...
					<div className="md:w-3/4 overflow-hidden">
						<div
							...
							{duplicatedSlides.map((testimonial, index) => (
								<div key={index} className="p-4" style={{ width: `${100 / duplicatedSlides.length}%` }}>
									<Tilt
