...
export default function Footer() {
  ...
  const draw: Variants = {
    ...
    visible: (i: number) => {
      // Added type 'number' for the custom prop 'i'
      const delay = 1 + i * 0.5;
      return {
        pathLength: 1,
        opacity: 1,
...
>
  ...
  >
    ...
    <span className="hidden sm:block">Send</span> {/* Text on larger screens */}
        ...
        <div className="container mx-auto py-8">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="md:col-span-1">
              ...
              <motion.p
                variants={fadeInUp}
                className="text-sm mb-6 text-white/90"
              >
                ...
                {[
                  ...
                  >
                    ...
                    <motion.span
                      ...
                      className="text-[#8FDDAA] hover:underline cursor-pointer"
                    >
                      {item.value}
                    </motion.span>
                  </motion.p>
      ...
      <motion.div
        variants={fadeInUp}
        className="border-t w-full text-white border-blue-400"
      >
