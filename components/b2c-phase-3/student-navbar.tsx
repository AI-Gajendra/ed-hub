...
export default function StudentNavbar({ activeState = "Home", isLanding = false }: { activeState?: string, isLanding?: boolean }) {
  ...
  const navLinks = [
    "/b2c-phase-3/b2c-student/student-flow/home",
    "/b2c-phase-3/b2c-student/student-flow/about-us",
    "/b2c-phase-3/b2c-student/student-flow/educator",
    "/b2c-phase-3/b2c-student/student-flow/courses",
    "/b2c-phase-3/b2c-student/student-flow/contact",
    "/b2c-phase-3/b2c-student/student-flow/dashboard",
  ];
      ...
      <nav className="bg-[#3366FF] text-white pt-5 px-4 md:px-8">
        ...
        >
          <div className="px-4 py-2 space-y-1 bg-[#3366FF]">
            <Link
              href="/b2c-phase-3/b2c-student/student-flow/home"
              className="block py-2 hover:bg-black/10 px-3 rounded-md transition-colors duration-200"
            >
              Home
            </Link>
            <Link
              href="/b2c-phase-3/b2c-student/student-flow/about-us"
              className="block py-2 hover:bg-black/10 px-3 rounded-md transition-colors duration-200"
            >
              About
            </Link>
            <Link
              href="/b2c-phase-3/b2c-student/student-flow/educator"
              className="block py-2 hover:bg-black/10 px-3 rounded-md transition-colors duration-200"
            >
              Instructor List
            </Link>
            <Link
              href="/b2c-phase-3/b2c-student/student-flow/courses"
              className="block py-2 hover:bg-black/10 px-3 rounded-md transition-colors duration-200"
            >
              Courses List
            </Link>
            <Link
              href="/b2c-phase-3/b2c-student/student-flow/contact"
              className="block py-2 hover:bg-black/10 px-3 rounded-md transition-colors duration-200"
            >
              Contact
            </Link>
            <Link
              href="/b2c-phase-3/b2c-student/student-flow/dashboard"
              className="block py-2 hover:bg-black/10 px-3 rounded-md transition-colors duration-200"
            >
              My learnings
            </Link>
