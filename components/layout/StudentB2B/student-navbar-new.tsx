...
export default function StudentNavbarNew({ activeState = "My Learnings" }: { activeState?: string }) {
  ...
  const navItems = [
    ...
    {
      href: "/student-b2b/student-flow/my-course",
      label: "My course",
      icon: LayoutGrid,
    },
    {
    ...
    {
      href: "/student-b2b/student-flow/recording",
      label: "Recordings",
      icon: Video,
    },
  ];
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="flex items-center justify-between gap-2 h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Notification Bell */}
              <Link href="/student-b2b/student-flow/notification">
              ...
              {/* Profile Picture */}
              <Link href="/student-b2b/student-flow/profile-view" className="relative h-11 w-11 rounded-full overflow-hidden ">
                <Image
