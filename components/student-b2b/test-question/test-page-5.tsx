                ...
                <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-xl p-6 md:p-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                        ...
                        <div className="text-right">
                            ...
                            flex"> <Image src="/images/Tip.png" alt="Ask me bot" className="w-[40px]" width={10} height={10} /><span>Draw in the box to complete the task</span></p>
                        </div>
                    </div>
                    ...
                    {currentQuestion && (
                        <div className="bg-gray-50 p-6 rounded-2xl">
                            ...
                            <h2 className="text-lg font-bold text-gray-800 mb-0">{currentQuestion.text}</h2>
