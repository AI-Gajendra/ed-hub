...
const sampleQuestions: Question[] = [
	{
		id: 1,
		text: 'Combine the top two fingures to make a new figure below.',
		options: [
			{ id: 'a', text: 'Roots' },
			{ id: 'b', text: 'Leaves' },
			{ id: 'c', text: 'Stem' },
				...
				<div className="max-w-[53rem] mx-auto bg-white rounded-xl md:p-8">
					...
					{currentQuestion && (
						<div className="bg-gray-50 p-6 rounded-2xl">
							...
							<h2 className="text-lg  text-gray-800 mb-0 tracking-wide font-bold">{currentQuestion.text}</h2>
						</div>
					)}
					...
					<div className="mt-10 flex justify-center rounded-full">
						<button
							...
							onClick={() => router.push("/student-b2b/test/page-5")}
