        ...
        <div className="bg-[#EEEEEE] min-h-screen flex flex-col">
            ...
            <main className="flex-grow mt-[30px] px-10 pb-10">
                ...
                <div className="w-full bg-[#f1f1f1] py-3 px-0">
                    <div className="w-full bg-white rounded-[25px] shadow-md px-6 py-2 flex items-center justify-between">
                ...
                ${activeSubject === subject
                                            ...
                                            : 'text-gray-500 font-bold hover:text-pink-500'}`}
                                >
                                    {subject}
                                </button>
                            ))}
                    ...
                    <div className="flex">
                        ...
                        <div className="flex flex-col w-[70%] py-4">
                            ...
                            <div className="image-content-box  px-10 py-4">
                                <Image
                                    src="/images/image 575.svg" // Replace with actual avatar path
                                    alt="Shlok Agheda"
                                    width={100}
                                    height={100}
                                    className="w-[100%]"
