      ...
      <main className="bg-white flex-1 py-8 ">
        <div className="lg:max-w-[62%] mx-auto bg-white rounded-xl  p-6 md:p-8">
            ...
            <div className="flex max-w-[55%] min-w-full space-x-1 border bg-[#f9fafb] border-gray-200 rounded-full p-2">
              {tabCategories.map((category) => (
                <button
                  ...
                  className={`px-4 py-2 text-xs md:text-sm font-medium whitespace-nowrap transition-colors duration-150 rounded-full ${
          ...
          <div className="mt-10 flex justify-center rounded-full">
            <button
              onClick={() => router.push("/b2c-student/test/test-page-9")}
